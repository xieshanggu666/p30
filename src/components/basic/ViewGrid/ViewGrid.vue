<template>
  <div class="layout-container">
    ...
    <component
      :is="dynamicComponent.gridCenter"
      ref="gridCenter"
      @parentCall="parentCall"
    ></component>

    <component
      :is="dynamicComponent.gridAnalysis"
      ref="gridAnalysis"
      @parentCall="parentCall"
    ></component>
    <component
      :is="dynamicComponent.gridXjcyis"
      ref="gridXjcyis"
      @parentCall="parentCall"
    ></component>
    <component
      :is="dynamicComponent.gridKalman"
      ref="gridKalman"
      @parentCall="parentCall"
    ></component>

    <component
      :is="dynamicComponent.gridKalmanInfo"
      ref="gridKalmanInfo"
      @parentCall="parentCall"
    ></component>
    ...
    <!-- 四维 -->
    <component
      :is="dynamicComponent.gridTimelyRadar"
      ref="gridTimelyRadar"
      @parentCall="parentCall"
    ></component>

     <component
      :is="dynamicComponent.gridHistoryRadar"
      ref="gridHistoryRadar"
      @parentCall="parentCall"
    ></component>

     <component
      :is="dynamicComponent.gridFrequency"
      ref="gridFrequency"
      @parentCall="parentCall"
    ></component>

     <component
      :is="dynamicComponent.gridConfiguration"
      ref="gridConfiguration"
      @parentCall="parentCall"
    ></component>
    <!-- 震动 -->
     <component
      :is="dynamicComponent.gridShake"
      ref="gridShake"
      @parentCall="parentCall"
    ></component>
    ...
    <!-- 公式模版 -->
    <component
      :is="dynamicComponent.gridMathSet"
      ref="gridMathSet"
      @parentCall="parentCall"
    ></component>
  </div>
...
var vueParam = {
  ...
  setup(props) {
    ...
    const dynamicCom = {
      ...
      gridXjcyis:Empty,
      gridKalman:Empty,
      gridKalmanInfo:Empty,
      // 四维
      gridTimelyRadar:Empty,
      gridHistoryRadar:Empty,
      gridFrequency:Empty,
      gridConfiguration:Empty,
