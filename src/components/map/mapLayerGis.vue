...
<script>
export default {
  props: ["AngleData", "groups","groudId"],
  name: "gisBoxLayer",
  data() {
    return {
      EarthIds: [],
  ...
  mounted() {
    this.gisInit();
    // console.log("groudIdgroudIdgroudIdgroudIdgroudId",this.groudId);
    // console.log("this.AngleData.Description", this.AngleData);
  ...
  methods: {
    ...
    SaveD3Angle() {
      ...
      // console.log("111", this.viewer.camera.direction);
      // console.log("222", this.viewer.camera.up);
      let direction=this.viewer.camera.direction
      let up=this.viewer.camera.up
      let position=this.viewer.camera.position
      let right=this.viewer.camera.right
