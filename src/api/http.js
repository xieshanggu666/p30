...
if (process.env.NODE_ENV == 'development') {
    axios.defaults.baseURL = 'http://smp.cnzwjl.com:29991/';
}
// http://148.70.164.88:9991 29991
// http://127.0.0.1:9991/1
// 159.75.243.87
...
function download (url, params, fileName, loading,callback) {
    ...
    post(url, params, loading, { responseType: 'blob' }).then(content => {
        ...
        if ('download' in document.createElement('a')) { // 非IE下载
            ...
            document.bodyNaNpxoveChild(elink)
        } else { // IE10+下载
...
export default { post, get,download, ajax, ipAddress,axios }
