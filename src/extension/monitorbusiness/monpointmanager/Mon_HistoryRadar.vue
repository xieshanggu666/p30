  ...
  <div>
    ...
    >
      <div class="right-table">
        ...
        <!-- 历史点云图 -->
        <timelyRadarH ref="openTimeRadar"></timelyRadarH>
      </div>
    </vol-box>
  </div>
</template>
...
import timelyRadarH from "./Mon_timelyRadarH.vue";
...
export default {
            ...
            return h("div", { style: { cursor: "pointer" } }, [
              h(
                resolveComponent("el-button"),
                {
                  ...
                  onClick: (e) => {
                    e.stopPropagation();
                      this.$refs.openTimeRadar.openTimeRadar(row);
                  },
                },
                [h("i", { class: "el-icon-document" }, "点云数据")]
              ),
            ]);
          },
        },
  ...
  methods: {
    ...
    getRadarInfo() {
      ...
      let url = `/api/Mon_Point_Manager/GetHistoryPointCloudData?pointNum=${this.Point_Num}&startTime=${this.startTime}&endTime=${this.endTime}&pageSize=${this.pageSize}&pageIndex=${this.pageIndex}`;
