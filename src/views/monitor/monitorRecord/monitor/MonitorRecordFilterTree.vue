...
export default {
  ...
  methods: {
    ...
    load() {
      let url = `api/Mon_Group_Manager/GetProjectGroupTree?isCreateGroup=true&isCreateMonitor=true`;
      this.http.get(url, {}, true).then((result) => {
        ...
        //设置默认打开的菜单
        this.openKeys.push(
          this.tree[0].children[0].children[0].children[0].children[0].id
        );
        ...
        this.data = this.tree[0].children[0].children[0].children[0].children[0];
