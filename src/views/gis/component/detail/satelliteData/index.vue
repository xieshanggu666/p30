<template>
  <div id="satellite-data">
    ...
    <div class="right-box">
      <div class="flex-box">
        <chart-polar-1 class="polar" :getParam="choosedDeviceItemInfo" :id="'polar-1'"></chart-polar-1>
        <chart-polar-2 class="polar" :getParam="choosedDeviceItemInfo" :id="'polar-2'"></chart-polar-2>
        <chart-polar-3 class="polar" :getParam="choosedDeviceItemInfo" :id="'polar-3'"></chart-polar-3>
      </div>
      <div class="flex-box" style="margin-top:30px;" v-loading="loading" element-loading-text="拼命加载中"
        element-loading-spinner="el-icon-loading" element-loading-background="rgba(0, 0, 0, 0.8)">
        <chart-bar ref="bar1" :getParam="choosedDeviceItemInfo" :id="'bar-1'" :title="'北斗卫星信噪比'"></chart-bar>
        <chart-bar ref="bar2" :getParam="choosedDeviceItemInfo" :id="'bar-2'" :title="'GPS卫星信噪比'"></chart-bar>
        <chart-bar ref="bar3" :getParam="choosedDeviceItemInfo" :id="'bar-3'" :title="'Galileo卫星信噪比'"></chart-bar>
        <chart-bar ref="bar4" :getParam="choosedDeviceItemInfo" :id="'bar-4'" :title="'GLONASS卫星信噪比'"></chart-bar>
      </div>
    </div>
  </div>
</template>
