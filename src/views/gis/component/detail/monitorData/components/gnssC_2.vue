<template>
    <div id="gnssC_1">
      ...
      <chart class="chart-box" :getParam="chartData" :id="'point-chart-2'" :activeName="activeName" v-if="activeName=='gnssC_2'"></chart>
    </div>
  </template>
  ...
  export default {
    mixins: [commen],
    props: ["currentDevice","activeName"],
    watch: {
      currentDevice() {
    ...
    components: {
      chart: () => import('./chart-line-gnss-2.vue')
    },
    computed: {
      startTime: function () {
