<template>
    <div id="gnss">
        ...
        <el-table :data="tableData" style="width: 100%" v-loading="loading">
            ...
            <el-table-column prop="pointNum" label="监测点名称">
            </el-table-column>
            <el-table-column prop="mnId" label="监测点编号">
            </el-table-column>
            <el-table-column prop="createGmt" label="创建时间">
            </el-table-column>
        </el-table>
        <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange"
            :current-page="pagination.currentPage" :page-sizes="pagination.pageSizesArr"
            :page-size="pagination.pageSizes" layout="total, sizes, prev, pager, next, jumper"
...
// import { DASgetBaseStationList } from "@/api/page/dataMonitor/index"
export default {
    mixins: [commen],
    props: ["currentDevice"],
    watch: {
    ...
    methods: {
        GetPaginationList() {
            ...
            this.loading = true;
            DASgetBaseStationList(getParam).then(res => {
                console.log(res, 'res');
