...
// import { DASrunIndexData } from "@/api/page/gis/detail"
...
export default {
    ...
    data() {
        return {
            ...
            chartData: {},
            chartParam: {
                legendData: ['CPU温度', '设备温度', '电池电压', 'GPRS信号强度'],
    ...
    methods: {
        ...
        pageInit() {
            ...
            if (this.getParam.toString().length > 3) {
                DASrunIndexData(this.getParam).then(res => {
                    console.log(res,'res');
                    this.chartData = res;
                    this.compileData();
                })
