...
export default {
  ...
  methods: {
    ...
    getMonitorData(data, newTime, oldTime) {
      let url = `/api/Mon_Point_Manager/GetMonitorData?pointNum=${data}&startTime=${oldTime}&endTime=${newTime}&pageIndex=${this.currentPage}&pageSize=${this.pageSize}`;
