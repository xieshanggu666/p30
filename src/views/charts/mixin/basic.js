  ...
  methods: {
    ...
    leftDownAction() {
      ...
      handler.setInputAction(function (movement) {
        ...
        console.log("弹框信息方法action", picked);
    ...
    MoveLocal(positionData, flyFlag = true) {
      ...
      if (positionData.GIS_Config || positionData.giS_Config) {
        ...
        let localPointData = {
          destination:
            three_object && three_object.position
              ? three_object.position
              : position,
          orientation: {
            direction:
              three_object && three_object.direction
                ? three_object.direction
                : this.viewer.camera.direction,
            up:
              three_object && three_object.up
                ? three_object.up
                : this.viewer.camera.up,
            right:
              three_object && three_object.right
                ? three_object.right
